...
var BaseEntry = {
	isDetectable: 1,       # Radar and RWR will ignore this if false
...
# OPRF assets (emesary enabled)
    ...
    "ZSU-23-4M":              {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"AA", baseDangerNM: 7.5, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "SA-6":                   {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"6", baseDangerNM: 15, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "buk-m2":                 {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"17", baseDangerNM: 35, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "buk-m1-2":               {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"17", baseDangerNM: 35, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "S-75":                   {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"2", baseDangerNM: 35, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "s-200":                  {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"5", baseDangerNM: 150, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "s-300":                  {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"20", baseDangerNM: 80, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "MIM104D":                {isSurfaceAsset: 1, canFly: 0, hasAirRadar:1, rwrCode:"P", baseDangerNM: 45, radarHorzRadius: 180, baseThreat:defaultSurfaceThreat},
    "truck":                  {isSurfaceAsset: 1, canFly: 0},
    "missile_frigate":        {isShip: 1, canFly: 0, hasAirRadar:1, rwrCode:"SH", baseDangerNM: 80, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
    "fleet":                  {isShip: 1, canFly: 0, hasAirRadar:1, rwrCode:"SH", baseDangerNM: 80, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
    "frigate":                {isShip: 1, canFly: 0, hasAirRadar:1, rwrCode:"SH", baseDangerNM: 80, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
...
# Hunter ships (emesary enabled)
    "USS-NORMANDY":           {hasAirRadar:1, canFly: 0, isShip: 1, radarHorzRadius: 180, rwrCode:"SH", baseDangerNM: 80, baseThreat:defaultMissileShipThreat},
    "USS-LakeChamplain":      {hasAirRadar:1, canFly: 0, isShip: 1, radarHorzRadius: 180, rwrCode:"SH", baseDangerNM: 80, baseThreat:defaultMissileShipThreat},
    "USS-OliverPerry":        {hasAirRadar:1, canFly: 0, isShip: 1, radarHorzRadius: 180, rwrCode:"SH", baseDangerNM: 80, baseThreat:defaultMissileShipThreat},
    "USS-SanAntonio":         {hasAirRadar:1, canFly: 0, isShip: 1, radarHorzRadius: 180, rwrCode:"SH", baseDangerNM: 80, baseThreat:defaultMissileShipThreat},
# Carriers
	"mp-clemenceau":          {hasAirRadar:1, canFly: 0, isShip: 1, isCarrier: 1, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
	"mp-eisenhower":          {hasAirRadar:1, canFly: 0, isShip: 1, isCarrier: 1, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
	"mp-nimitz":              {hasAirRadar:1, canFly: 0, isShip: 1, isCarrier: 1, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
	"mp-vinson":              {hasAirRadar:1, canFly: 0, isShip: 1, isCarrier: 1, radarHorzRadius: 180, baseThreat:defaultMissileShipThreat},
# Drones
