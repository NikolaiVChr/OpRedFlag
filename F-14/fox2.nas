...
var AIM9 = {
	new : func (p) {
		...
		m.thrust_duration_1 = getprop("sim/model/f-14b/systems/armament/aim9/stage-1-duration-sec");
		m.thrust_duration_2 = getprop("sim/model/f-14b/systems/armament/aim9/stage-2-duration-sec");
