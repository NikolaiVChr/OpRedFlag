...
var LaserDetection = radar.Radar.new(NewRangeTab:[20],NewRangeIndex:0,NewTypeTarget:["multiplayer","carrier","ship","missile"],NewRadarType:"laser", NewhaveSweep:0,NewAutoUpdate:0);
